              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="{{url('register_post')}}">
                    {{csrf_field()}}
                    <div class="col-12">
                      <label for="yourName" class="form-label" value="{{old('name')}}">Your First Name</label>
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="last_name" class="form-control" id="yourLast" required value="{{old('last_name')}}">
